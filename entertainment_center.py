import fresh_tomatoes #import fresh_tomatoes, to make the movies available on a web page
import media #import media to gain access to the class that defines each movie or instance


# The Wolf of Wall Street movie: Movie title, storyline, poster image and movie trailer
...
# The Conjuring movie: Movie title, storyline, poster image and movie trailer
...
# The Lone Survivor movie: Movie title, storyline, poster image and movie trailer
loneSurvivor = media.Movie(
	"Lone Survivor",
	"Marcus Luttrell and his team set out on a mission to capture or kill notorious Taliban leader" 
	"Ahmad Shah, in late June 2005. Marcus and his team are left to fight for their lives in one of the" 
...
# The 12 Years a Slave movie: Movie title, storyline, poster image and movie trailer
yearsaSlave = media.Movie(
	"12 Years a Slave",
	"In the antebellum United States, Solomon Northup, a free black man from upstate New York," 
...
# The Rush movie: Movie title, storyline, poster image and movie trailer
rush = media.Movie(
	"Rush",
...
# The Dallas Buyers Club movie: Movie title, storyline, poster image and movie trailer
dallasBuyersClub = media.Movie(
	"Dallas Buyers Club",
	"In 1985 Dallas, electrician and hustler Ron Woodroof works around the system to help AIDS" 
	"patients get the medication they need after he is diagnosed with the disease.",
...
# The Lovelace movie: Movie title, storyline, poster image and movie trailer
lovelace = media.Movie(
	"Lovelace",
	"The story of Linda Lovelace, who is used and abused by the porn industry at the behest of her coercive"
...
# The Yi dai zong shi movie: Movie title, storyline, poster image and movie trailer
...
# The Stalingrad movie: Movie title, storyline, poster image and movie trailer
stalingrad = media.Movie(
	"Stalingrad",
	"A band of Russian soldiers fight to hold a strategic building in their devastated city against"
	"a ruthless German army, and in the process become deeply connected to two Russian women who have been living there.",
...
#Upload the list of movies in fresh_tomatoes which will then allow to open the HTML and view the website.
